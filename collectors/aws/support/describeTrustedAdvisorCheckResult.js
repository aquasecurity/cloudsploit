...
module.exports = function(AWSConfig, collection, retries, settings, scanAWSConfig, callback) {
    ...
    async.eachLimit(collection.support.describeTrustedAdvisorChecks[AWSConfig.region].data, 15, function(check, cb) {
        ...
        helpers.makeCustomCollectorCall(support, 'describeTrustedAdvisorCheckResult', params, retries, null, null, null, settings, scanAWSConfig, AWSConfig, function(err, data) {
            if (err) {
