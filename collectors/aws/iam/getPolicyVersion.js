...
module.exports = function(AWSConfig, collection, retries, settings, scanAWSConfig, callback) {
    ...
    async.eachLimit(collection.iam.listPolicies[AWSConfig.region].data, 10, function(policy, cb){
        ...
        helpers.makeCustomCollectorCall(iam, 'getPolicyVersion', {PolicyArn: policy.Arn, VersionId: versionId}, retries, null, null, null, settings, scanAWSConfig, AWSConfig, function(err, data) {
            if (err) {
