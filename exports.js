...
module.exports = {
    ...
    'kmsDefaultKeyUsageSES'         : require(__dirname + '/plugins/kms/kmsDefaultKeyUsageSES.js'),
    'kmsDefaultKeyUsageCloudTrail'  : require(__dirname + '/plugins/kms/kmsDefaultKeyUsageCloudTrail.js'),
    'kmsDefaultKeyUsageS3'          : require(__dirname + '/plugins/kms/kmsDefaultKeyUsageS3.js'),
    'kmsDefaultKeyUsageEBS'         : require(__dirname + '/plugins/kms/kmsDefaultKeyUsageEBS.js'),
    'kmsDefaultKeyUsageRDS'         : require(__dirname + '/plugins/kms/kmsDefaultKeyUsageRDS.js'),
    'kmsDefaultKeyUsageRedshift'    : require(__dirname + '/plugins/kms/kmsDefaultKeyUsageRedshift.js'),
    'kmsDefaultKeyUsageWorkSpaces'  : require(__dirname + '/plugins/kms/kmsDefaultKeyUsageWorkSpaces.js'),
    'kmsDefaultKeyUsageElasticTranscoder'   : require(__dirname + '/plugins/kms/kmsDefaultKeyUsageElasticTranscoder.js'),
