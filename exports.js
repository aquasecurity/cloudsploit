...
module.exports = {
    aws : {
        ...
        'vpcPeeringLeastAccessRoutes'   : require(__dirname + '/plugins/aws/ec2/vpcPeeringLeastAccessRoutes.js'),
        ...
        'cloudShellFullAccess'          : require(__dirname + '/plugins/aws/iam/cloudShellFullAccess.js'),
