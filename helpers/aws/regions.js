...
module.exports = {
    default: ['us-east-1'],
    all: [...regions, ...newRegions, ...newRegion2],
    optin: ['ap-east-1', 'me-south-1', 'ap-southeast-3'],   // Regions that AWS disables by default
    accessanalyzer: [...regions, ...newRegions],
    acm: [...regions, ...newRegions, ...newRegion2],
    apigateway: [...regions, ...newRegions, ...newRegion2],
    athena: regions,
    cloudfront: ['us-east-1'], // CloudFront uses the default global region
    autoscaling: [...regions, ...newRegions, ...newRegion2],
    iam: ['us-east-1'],
    route53: ['us-east-1'],
    route53domains: ['us-east-1'],
    s3: ['us-east-1'],
    s3control: ['us-east-1'],
    cloudformation: [...regions, ...newRegions, ...newRegion2],
    cloudtrail: [...regions, ...newRegions, ...newRegion2],
    cloudwatchlogs: [...regions, ...newRegions, ...newRegion2],
    ...
    configservice: [...regions, ...newRegions, ...newRegion2],
    dax: [...regions, ...newRegions, ...newRegion2],
    ...
    dynamodb: [...regions, ...newRegions, ...newRegion2],
    ...
    dlm: [...regions, ...newRegions, ...newRegion2],
    dms: [...regions, ...newRegions, ...newRegion2],
    ec2: [...regions, ...newRegions, ...newRegion2],
    ecr: [...regions, ...newRegions, ...newRegion2],
    ...
    elb: [...regions, ...newRegions, ...newRegion2],
    elbv2: [...regions, ...newRegions, ...newRegion2],
    eventbridge: [...regions, ...newRegions, ...newRegion2],
    emr: [...regions, ...newRegions, ...newRegion2],
    es: [...regions, ...newRegions, ...newRegion2],
    glue: [...regions, ...newRegions],
    kinesis: [...regions, ...newRegions, ...newRegion2],
    ...
    kms: [...regions, ...newRegions, ...newRegion2],
    vpc: [...regions, ...newRegions, ...newRegion2],
    flowlogs: [...regions, ...newRegions, ...newRegion2],
    rds: [...regions, ...newRegions, ...newRegion2],
    redshift: [...regions, ...newRegions, ...newRegion2],
    cloudwatch: [...regions, ...newRegions, ...newRegion2],
    ecs: [...regions, ...newRegions, ...newRegion2],
    resourcegroupstaggingapi: [...regions, ...newRegions],
    sagemaker: [...regions, newRegions],
    secretsmanager: [...regions, ...newRegions, ...newRegion2],
    ...
    sns: [...regions, ...newRegions, ...newRegion2],
    sqs: [...regions, ...newRegions, ...newRegion2],
    ssm: [...regions, ...newRegions, ...newRegion2],
    shield: ['us-east-1'],
    sqs_encrypted: [...regions, ...newRegions, ...newRegion2],
    sts: ['us-east-1'],
    transfer: regions,
    lambda: [...regions, ...newRegions, ...newRegion2],
    ...
    efs: [...regions, ...newRegions, ...newRegion2],
    support: ['us-east-1'],
    wafregional: regions,
    wafv2: regions,
    waf: ['us-east-1'],
    organizations: ['us-east-1'],
    guardduty: [...regions, ...newRegions, ...newRegion2],
    ...
    xray: [...regions, ...newRegions, ...newRegion2],
    ...
    elasticache: [...regions, ...newRegions, ...newRegion2],
    ...
    appconfig: [...regions, ...newRegions, ...newRegion2]
};
