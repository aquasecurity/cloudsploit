...
module.exports = {
    ...
    run: function(cache, settings, callback) {
        ...
        helpers.checkOrgPolicy(orgPolicies, 'iam.disableWorkloadIdentityClusterCreation', 'booleanPolicy', true, false,  'Disable Workload Identity Cluster Creation', results);
