...
module.exports = {
    ...
    realtime_triggers: ['compute.instances.insert', 'compute.instances.delete','compute.disks.testiampermissions','compute.disks.delete', 'compute.images.insert', 'compute.images.delete', 'compute.images.deprecate'],
