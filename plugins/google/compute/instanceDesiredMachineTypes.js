...
module.exports = {
    ...
    settings: {
        instance_desired_machine_types: {
            ...
            description: 'Desired Google Cloud Virtual Machine instance type',
            regex: '^.*$',
            default: ''
        },
    },
                ...
                instances.data.forEach(instance => {
                    ...
                    if (instance.machineType && instance_desired_machine_types.includes((instance.machineType.split('machineTypes/')[1]))) {
                        helpers.addResult(results, 0,
                            'Google Cloud Virtual Machine instance has the desired machine type', region, resource);
                    } else {
                        helpers.addResult(results, 2,
                            'Google Cloud Virtual Machine instance does not have the desired machine type', region, resource);
                    }    
                });
                zcb();
            }, function() {
