...
module.exports = {
    ...
    description: 'Ensures that Azure Web Apps have Registration with Azure Active Directory is Enabled.',
    ...
    recommended_action: 'Enable Registration with Azurre Active Directory for Azure Web Apps',
