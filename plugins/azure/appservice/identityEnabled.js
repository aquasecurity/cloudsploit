...
module.exports = {
    ...
    description: 'Ensures a system or user assigned managed identity is enabled to authenticate to App Service without storing credentials in code.',
    ...
    run: function (cache, settings, callback) {
        ...
        async.each(locations.webApps, function (location, rcb) {
            ...
            const webApps = helpers.addSource(
                cache, source, ['webApps', 'get', location]
            );
