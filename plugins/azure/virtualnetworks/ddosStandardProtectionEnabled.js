...
module.exports = {
    ...
    more_info: 'DDoS Protection Standard offers enhanced Distributed Denial-of-Service (DDoS) mitigation capabilities \
        via adaptive tuning, attack alert notifications, and telemetry to protect against the impacts of large DDoS attacks \
        for all the protected resources available within your Azure Virtual Networks.',
