...
var attachedDiskByokEncryptionEnabled = require('./attachedDiskByokEncryptionEnabled');
...
describe('attachedDiskByokEncryptionEnabled', function() {
    describe('run', function() {
        it('should give passing result if no disk volumes found', function(done) {
            const cache = createCache([]);
            attachedDiskByokEncryptionEnabled.run(cache, {}, (err, results) => {
