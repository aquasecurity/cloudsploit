...
module.exports = {
    ...
    more_info: 'The data for your temporary disk and OS/data disk caches is stored on the VM host, enabling encyrption at host for Azure Virtual Machine disks allows that data to be end-to-end encrypted, ensuring compliance and bolstering overall security with Azure Disk Encryption.',
