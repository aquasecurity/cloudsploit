...
module.exports = {
    ...
    more_info: 'Configuring container apps with volume mounts ensures the availability of persistent storage, guaranteeing data integrity and facilitating seamless data sharing among containers.Using volume mounts in Azure Container Apps ensures persistent storage, enabling data integrity and seamless sharing among containers. By configuring volume mounts, data remains available even after container restarts or failures, facilitating backup, scalability, and simplified management of applications',
