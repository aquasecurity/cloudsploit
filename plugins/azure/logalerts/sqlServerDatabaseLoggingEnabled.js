...
module.exports = {
    ...
    description: 'Ensures Activity Log alerts for the create or update SQL Server Database events are enabled',
    more_info: 'Monitoring for create or update SQL Server Database events gives insight into network access changes and may reduce the time it takes to detect suspicious activity.',
    recommended_action: 'Add a new log alert to the Alerts service that monitors for SQL Server Database create or update events.',
