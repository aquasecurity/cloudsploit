...
module.exports = {
    ...
    domain: 'Databases',
    severity: 'Medium',
    description: 'Ensures disconnection logs are enabled  for Postgresql flexible servers',
    more_info: 'Disconnection logs ensure all attempted and successful disconnections from the server are logged.',
    recommended_action: 'Ensure the server parameters for each Postgresql flexible server have the log_disconnections setting enabled.',
