...
describe('openHTTP', function() {
    describe('run', function() {
        ...
        it('should PASS if security group has HTTP TCP port 80 not open to public', function(done) {
        ...
        it('should FAIL if security group has HTTP TCP port 80 open to public', function(done) {
