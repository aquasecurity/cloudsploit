...
module.exports = {
    ...
    more_info: 'Examine network security groups for inbound rules that allow unrestricted access (i.e. 0.0.0.0/0) to TCP port 80 and restrict access to only known IP addresses in order to implement the principle of least privilege and reduce the possibility of a breach.',
