...
module.exports = {
    ...
    severity: 'Medium',
    description: 'Ensures that Azure Front Door have managed identity enabled.',
    ...
    recommended_action: 'Modify the Front Door classic profile and add managed identity.',
