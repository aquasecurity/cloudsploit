...
module.exports = {
    ...
    severity: 'Medium',
    description: 'Ensures that Azure API Management service instance has tags associated.',
        ...
        async.each(locations.apiManagementService, function(location, rcb){
            ...
            for (let apiInstance of apiManagementService.data) {
                ...
                if (apiInstance.tags && Object.entries(apiInstance.tags).length > 0) {
                    helpers.addResult(results, 0, 'API Management service instance has tags associated', location, apiInstance.id);
                } else {
                    helpers.addResult(results, 2, 'API Management service instance does not have tags associated', location, apiInstance.id);
                }
            }
