...
module.exports = {
    ...
    more_info: 'To secure your SQL server, it is recommended to disable public network access or disable Exceptions rule: "Allow Azure services and resources to access this server". Instead, configure firewall rules to allow connections from specific network ranges or utilize VNET rules for access from designated virtual networks. This helps prevent unauthorized access from Azure services outside your subscription.',
