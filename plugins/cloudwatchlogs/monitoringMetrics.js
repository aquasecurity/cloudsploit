...
module.exports = {
	...
	more_info: 'Sending CloudTrail logs to CloudWatch is only useful if metrics are setup to detect risky activity from those logs. There are numerous metrics that should be used. For the exact filter patters, please see this plugin on GitHub: https://github.com/cloudsploit/scans/plugins/cloudwatchlogs/monitoringMetrics.js',
