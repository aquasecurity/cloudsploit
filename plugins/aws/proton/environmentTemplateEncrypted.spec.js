...
describe('environmentTemplateEncrypted', function () {
    describe('run', function () {
        it('should PASS if Environment Template is encrypted with desired encryption level', function (done) {
            const cache = createCache([listEnvironmentTemplates[0]], listKeys, getEnvironmentTemplate[0], describeKey[0]);
            environmentTemplateEncrypted.run(cache, { proton_environment_template_encryption : 'awscmk' }, (err, results) => {
        ...
        it('should FAIL if Environment Template not encrypted with desired encryption level', function (done) {
        ...
        it('should PASS if no Environment Template found', function (done) {
        ...
        it('should UNKNOWN if unable to list Environment Template', function (done) {
            const cache = createCache(null, null, null, { message: "Unable to list Environment Template" });
            environmentTemplateEncrypted.run(cache, {}, (err, results) => {
                expect(results.length).to.equal(1);
