...
module.exports = {
    ...
    category: 'S3',
    description: 'Ensures S3 Glacier Vault public access block is enabled for the account',
    ...
    run: function (cache, settings, callback) {
        ...
        regions.glacier.forEach(region => {
            ...
            if (listVaults.err || !listVaults.data) {
                helpers.addResult(results, 3, `Unable to list S3 glacier vaults: ${helpers.addError(listVaults)}`);
                return;
            }
