...
describe('danglingDnsRecords', function () {
    describe('run', function () {
        it('should PASS if Hosted Zone does not have DNS records pointing to invalid/deleted EIPs', function (done) {
        ...
        it('should FAIL if Hosted Zone has DNS records pointing to invalid/deleted EIPs', function (done) {
        ...
        it('should not return anything if list hosted zones response is not found', function (done) {
