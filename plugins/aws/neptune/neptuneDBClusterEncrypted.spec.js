...
describe('neptuneDBClusterEncrypted', function () {
    describe('run', function () {
        it('should PASS if Neptune Database Cluster is encrypted with desired encryption level', function (done) {
            ...
            neptuneDBClusterEncrypted.run(cache, { neptune_db_cluster_encryption_level: 'awscmk' }, (err, results) => {
                console.log(results);
        ...
        it('should FAIL if Neptune Database Clusters is not encrypted with desired encyption level', function (done) {
