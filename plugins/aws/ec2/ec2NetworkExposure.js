...
module.exports = {
    ...
    apis: ['EC2:describeInstances', 'EC2:describeNetworkAcls', 'EC2:describeSecurityGroups', 'EC2:describeNetworkInterfaces', 'EC2:describeSubnets', 'EC2:describeRouteTables'],
        ...
        async.each(regions.ec2, function(region, rcb){
            ...
            for (var instances of describeInstances.data){
                ...
                for (var instance of instances.Instances) {
                    ...
                    let internetExposed = helpers.checkNetworkExposure(cache, source, instance.SubnetId, instance.SecurityGroups, region, results);
