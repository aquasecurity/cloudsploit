...
const internetGatewayAssociatedVPC = require('./internetGatewayAssociatedVPC');
...
describe('internetGatewayAssociatedVPC', function () {
    describe('run', function () {
        it('should PASS if Internet Gateway is associated with VPC', function (done) {
            ...
            internetGatewayAssociatedVPC.run(cache, {}, (err, results) => {
