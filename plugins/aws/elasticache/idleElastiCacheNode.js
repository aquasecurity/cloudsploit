...
module.exports = {
    ...
    settings: {
        elasticache_idle_node_percentage: {
            ...
            description: 'A percentage value under which cluster is considered idle for upto two decimal places i.e 10.55 by gaining data of 3 days',
            ...
            describeCacheClusters.data.forEach(cluster => {
                ...
                if (!getEcMetricStatistics.data.Datapoints.length) {
                    helpers.addResult(results, 0,
                        'ElastiCache cluster does not have any metric statistics', region, resource);
                    return;
                } else {
