...
module.exports = {
    ...
    run: function(cache, settings, callback) {
        ...
        var deprecatedRuntimes = [
            ...
            { 'id':'nodejs4.3', 'name': 'Node.js 4.3', 'endOfLifeDate': '2020-03-06' },
            ...
            { 'id':'dotnetcore2.1', 'name': '.Net Core 2.1', 'endOfLifeDate': '2022-04-13' },
            { 'id':'dotnetcore2.0', 'name': '.Net Core 2.0', 'endOfLifeDate': '2019-05-30' },
            { 'id':'dotnetcore1.0', 'name': '.Net Core 1.0', 'endOfLifeDate': '2019-07-30' },
            { 'id':'python2.7', 'name': 'Python 2.7', 'endOfLifeDate': '2022-02-14' },
            { 'id':'python3.6', 'name': 'Python 3.6', 'endOfLifeDate': '2022-08-17' },
