...
module.exports = {
    ...
    settings: {
        rds_idle_instance_cpu_percentage: {
            ...
            description: 'Return a failing result when consumed RDS instance cpu threshold equals or less this percentage',
            regex: '^(100|[1-9][0-9]?)$', 
            default: '1.0'
        },
        rds_idle_instance_readIOPS_percentage: {
            name: 'RDS Idle Instance Average Read IOPS Percentage',
            description: 'Return a failing result when consumed RDS instance read IOPS threshold equals or less this percentage',
            regex: '^(100|[1-9][0-9]?)$', 
            default: '20'
        },
        rds_idle_instance_writeIOPS_percentage: {
            name: 'RDS Idle Instance Average Write IOPS Percentage',
            description: 'Return a failing result when consumed RDS instance write IOPS threshold equals or less this percentage',
            regex: '^(100|[1-9][0-9]?)$', 
            default: '20'
        }
    },
