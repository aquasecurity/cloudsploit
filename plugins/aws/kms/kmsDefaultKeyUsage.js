...
module.exports = {
    ...
    realtime_triggers: ['cloudtrail:CreateTrail', 'ec2:CreateVolume','elastictranscoder:CreatePipline', 'rds:CreateDBInstance', 'redshift:CreateCluster', 's3:CreateBucket','s3:putBucketEncryption','ses:CreateEmailIdentity', 'workspace:CreateWorkSpaces',  'lambda:CreateFunction', 'cloudwatchlogs:CreateLogGroup', 'efs:CreateFileSystem'],
