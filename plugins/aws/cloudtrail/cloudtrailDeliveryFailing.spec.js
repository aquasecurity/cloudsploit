...
describe('cloudtrailDeliveryFailing', function () {
    describe('run', function () {
        it('should PASS if CloudTrail trail logs are being delivered to the destination bucket', function (done) {
        ...
        it('should FAIL if CloudTrail trail logs are not being delivered to the destination bucket', function (done) {
