...
module.exports = {
    ...
    category: 'RAM',
    description: 'Ensure that RAM password security settings require logon to be blocked after max login attempts.',
    ...
    recommended_action: 'Update the password security settings to require logon to be blocked after max login attempts.',
