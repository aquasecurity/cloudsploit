...
module.exports = {
    ...
    category: 'OSS',
    description: 'Ensure that OSS buckets has Cross region replication enabled.',
    more_info: 'Enabling Cross region replication for OSS buckets provides automatic and asynchronous replication of objects across buckets in different Object Storage Service (OSS) regions.', // add desc
